...
export const programming = [
  {
    ...
    thoughts: "While designing the UX for Hyperloom, I discovered a love of brutalist typefaces in minimalist design. I designed and implemented a UX/UI spec and lead a fullstack team to win second place in Turing's internal Demo Comp.",
  ...
  },
  {
    ...
    thoughts: "I really enjoyed making Nectr. It was the first solo project I did was React and I learned a lot about prop drilling, effectively designing an MVP and how easy React makes app design.",
  ...
  },
  {
    ...
    img: bordle,
    mobile: bordleMobile,
    thoughts: "Bordle was the last in my series of game apps. I really enjoyed it was a continous work into the fun and silly side of programming. Instead of scalability, I looked to build something that could bring joy.",
